...
class QuestionCount(TimeStampedModel):
    ...
    # New Field: The counter for usage/events
    ...
    def __str__(self):
        return f"Q:{self.question_id} Count: {self.count} for Client:{self.client_id}"


class OrQuestionCount(TimeStampedModel):
    ...
    def __str__(self):
        return f"Org Q:{self.question_id} Count: {self.count} for Client:{self.client_id}"